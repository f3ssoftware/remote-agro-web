...
import {
  asyncFetchInputWeighingData,
  asyncFetchOutputWeighingData,
...
export function SeasonSelection({ show, handleClose }: any) {
  ...
  const [showSeasonsSelectionModal, setShowSeasonsSelectionModal] =
    useState(false)
  ...
  return (
    <Container>
      ...
      <SeasonsSelectionModal
        show={showSeasonsSelectionModal}
        handleClose={() => setShowSeasonsSelectionModal(false)}
      ></SeasonsSelectionModal>
    </Container>
  )
}
