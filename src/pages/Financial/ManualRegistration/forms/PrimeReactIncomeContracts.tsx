...
export function PrimeReactIncomeContracts({ isUpdate, contract }: { isUpdate?: boolean, contract?: Contract }) {
              ...
              <div className="field col-4">
                <span className="p-float-label">
                  <InputNumber
                    ...
                    className={classNames({
                      "p-invalid": formik.touched.contractValue && formik.errors.contractValue,
                    })}
                    mode="currency"
                    currency="BRL"
