...
export function DefensiveEventModal({ show, handleClose, application }: { show: boolean, handleClose: any, application: any }) {
    ...
    return (
        <Modal backdrop={'static'} show={show} onHide={handleClose} size={'xl'}>
            ...
            <Modal.Body style={{ backgroundColor: "#7C5529", color: '#fff' }}>
                ...
                <Row>
                    <Col>
                        Vazão: {plot?.applications[index]?.flow_rate} L/ha
                    </Col>
                </Row>
                <Row>
                    <Col>
