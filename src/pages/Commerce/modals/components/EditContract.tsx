...
export function EditContract({
  ...
  const { financial, seasons, commerce } = useSelector(
  ...
  useEffect(() => {
    ...
    if (
      commerce.editContracts.payment_date &&
      commerce.editContracts.start_date &&
      commerce.editContracts.end_date != null
    ) {
