        ...
        <Row style={{ marginTop: '5%' }}>
            ...
            <Col md={1}>
                <span className="p-float-label">
                    ...
                    <InputNumber value={initialQuantity} onChange={(e) => {
            ...
            <Col md={2}>
                <span className="p-float-label">
                    <InputNumber value={initialCost} onChange={(e) => {
        ...
        <div style={{ paddingLeft: '4%', paddingRight: '4%' }}>
            {!userHasProduct && isSeed ?
                <Row>
                    <Col md={12}>
                        <span className="p-float-label">
                            <Dropdown value={seedQuantityType} onChange={(e) => {
                                return setSeedQuantityType(e.target.value)
                            }} options={[{ label: 'Selecione um tipo' }, { label: 'KG', value: 'KG' }, { label: 'SACOS', value: 'SACOS' }, { label: 'UNIDADE', value: 'UNIDADE' }]} optionLabel="name" className="w-full md:w-14rem" style={{ width: '100%' }} />
                    ...
                    <Col>
                        <span className="p-float-label">
                            ...
                            }} options={[{ label: 'Selecione um tipo' }, { label: 'Não tratada', value: 'NÃO TRATADA' }, { label: 'Externo', value: 'EXTERNO' }, { label: 'Interno', value: 'INTERNO' }]} optionLabel="label" className="w-full md:w-14rem" style={{ width: '100%' }} />
